...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\nconst url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/LNcstlj7EXE5sePi5YgH/scores/';\r\n\r\nconst form = document.querySelector('.form');\r\n\r\n// const addNewUser = async () => {\r\n//     const user = document.querySelector('#user');\r\n//     const score = document.querySelector('#score');\r\n//     const userScore = { \r\n//       user : 'hassan',\r\n//       score : 400,\r\n//     }\r\n\r\n//     const postRequest = {\r\n//       method: 'POST',\r\n//       headers: {\r\n//         'Content-Type': 'application/json'\r\n//       },\r\n//       body: JSON.stringify(userScore),\r\n//     }\r\n\r\n//   await fetch(url, postRequest)\r\n//   .then((res) => res.json())\r\n// }\r\n\r\n\r\n\r\nform.addEventListener('submit', async (e) => {\r\n  e.preventDefault();\r\n  const userScore = { \r\n    user : e.target.user.value,\r\n    score : e.target.score.value,\r\n  }\r\n\r\n  const postRequest = {\r\n    method: 'POST',\r\n    headers: {\r\n      'Content-Type': 'application/json'\r\n    },\r\n    body: JSON.stringify(userScore),\r\n  }\r\n\r\nawait fetch(url, postRequest)\r\n.then((res) => res.json())\r\n} );\r\n\r\n// addNewUser();\r\n\r\nfetch(url)\r\n  .then((res) => res.json())\r\n  .then((data) => data.result.map(m => document.querySelector('.content').innerHTML += `<div >My name is ${m.user} : my score :${m.score} </div>`));\r\n\r\n// document.querySelector('.content').innerHTML += `<div >My name is ${m.user} : my score :${m.score} </div>`\r\n\r\n//  console.log(result) ;\r\n\r\n// function element(data){\r\n//   const { result } = data;\r\n//   return result;\r\n// }\r\n\r\n// console.log(element(result));\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
