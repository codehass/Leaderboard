...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _Modules_variables_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Modules/variables.js */ \"./src/Modules/variables.js\");\n\r\n\r\n\r\n_Modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.form.addEventListener('submit', async (e) => {\r\n  e.preventDefault();\r\n  const userScore = {\r\n    user: e.target.user.value,\r\n    score: e.target.score.value,\r\n  };\r\n\r\n  const postRequest = {\r\n    method: 'POST',\r\n    headers: {\r\n      'Content-Type': 'application/json',\r\n    },\r\n    body: JSON.stringify(userScore),\r\n  };\r\n\r\n  await fetch(_Modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.url, postRequest).then((res) => res.json());\r\n});\r\n\r\nconst addNewUser = (data) => {\r\n  _Modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.infos.innerHTML += `<div class =\"info\">${data.user} : ${data.score} </div>`;\r\n};\r\n\r\nfetch(_Modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.url)\r\n  .then((res) => res.json())\r\n  .then((data) => data.result.map((resp) => addNewUser(resp)));\r\n\r\n_Modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.refresh.addEventListener('click', () => {\r\n  window.location.reload();\r\n});\r\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
